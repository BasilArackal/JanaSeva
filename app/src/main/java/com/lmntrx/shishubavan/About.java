...
public class About extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String old_desc="Commenced in the year 1999, we, Janaseva Sisubhavan has initiated in this arena to eradicate the problem pertaining to child exploitation. Our sole vision is to eradicate child exploitation from the society and there by CREATE AN INDIA WITHOUT STREET CHILDREN.\n" +
                "\n" +
